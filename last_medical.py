...
def compare_texts(text1, text2):
    ...
    Представь результат в виде структурированного, оформленного текста БЕЗ Markdown или HTML. 
        Шаблон для оформления:
                    ...
                    Дата взятия материала: из первого файла 
                    Значение:  из первого файла 
                    Дата взятия материала: из второго файла
                    Значение: из второго файла 
                    Референс: взять более консервативный интервал из обоих файлов
    В заключении дай краткое резюме динамики показателей. Будь краток , но не упускай детали.
